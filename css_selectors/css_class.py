...
user_email = driver.find_element_by_css_selector("input.form-control")
user_password = driver.find_element_by_css_selector("input.textinput")
button = driver.find_element_by_css_selector("input.btn-primary")
